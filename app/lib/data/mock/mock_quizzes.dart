...
const mockQuizzes = [
  Quiz(id: 2, title: 'Biology quiz', subtitle: '18 topics', icon: Icons.eco_outlined, questionCount: 15, suggestedTime: '8 min', playedCount: 5564, questions: _mockQuestions),
  Quiz(id: 3, title: 'Chemistry quizzes', subtitle: '22 topics', icon: Icons.science_outlined, questionCount: 15, suggestedTime: '8 min', playedCount: 5564, questions: _mockQuestions),
  Quiz(id: 4, title: 'Geography quizzes', subtitle: '2 topics', icon: Icons.public_outlined, questionCount: 15, suggestedTime: '8 min', playedCount: 5564, questions: _mockQuestions),
  Quiz(id: 5, title: 'Computer science', subtitle: '1 topics', icon: Icons.memory_outlined, questionCount: 15, suggestedTime: '8 min', playedCount: 5564, questions: _mockQuestions),
];
